...
export class ShoppingService {
    items: ShoppingCart[] = [
        ...
        },
        {
            ...
            description: "Situated at the end of a picturesque street on 10.24 acres of sprawling meadows and aspen groves sits this breathtaking mountain estate. Located in Park City's most coveted gated development, this is a 8,603 sqft. modern yet classic mountain retreat designed by renowned architect Michael Upwall. This iconic private residence has multiple indoor-outdoor living spaces providing natural light from expansive walls of glass.",
            price: "7,900,000",
        ...
        },
        {
            ...
            description: "Mountain is the most exquisite, new modern contemporary estate that encompasses the finest in materials, technology and views. 75-foot long - suspended glass bottom pool with exceptional Gore Range views, rejuvenating spa with waterfall, freestanding elevator with glass ceiling,4-car garage, 4 covered parking spaces and car rinse are some of the special features of this amazing estate. Designed with glass view corridors and sliding walls that seamlessly flow the living area into the exterior decks, patios and gardens. ",
            price: "39,990,000",
